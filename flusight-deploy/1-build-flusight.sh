...
# Change footer text from bottom of score table
sed -i 's/Calculated using the most recently updated data. Final values may differ./These are single bin scores. Scores for the latest season (2017-2018) are based on most recently updated data. Final values may differ./' ./src/components/Panels/TimeChart.vue
