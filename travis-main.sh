...
if [ "$TRAVIS_COMMIT_MESSAGE" == "autogenerated csvs" ]; then
...
echo "> Pushing scores and model-id-mapping csvs"
git add ./scores/scores.csv
git add ./model-forecasts/component-models/complete-modelids.csv
git add ./model-forecasts/cv-ensemble-models/complete-modelids.csv
git add ./model-forecasts/real-time-ensemble-models/complete-modelids.csv
