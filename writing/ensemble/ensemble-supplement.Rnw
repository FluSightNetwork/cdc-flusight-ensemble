...
\author{Nicholas G Reich, Craig McGowan, Logan Brooks, Sasikiran Kandula,\\Evan Moore, Dave Osthus, Evan Ray, Abhinav Tushar, Teresa Yamana,\\
Willow Crawford-Crudell, Graham Casey Gibson, Rebecca Silva\\Matthew Biggerstaff, Michael A Johansson, Roni Rosenfeld, Jeffrey Shaman}
...
<<pit-all-seasons, cache=TRUE, fig.cap="Probability integral transform histograms by target for the FSNetwork-TTW model in all training seasons: 2010/2011 through 2016/2017.">>=
