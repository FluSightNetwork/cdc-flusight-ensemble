...
\begin{eqnarray}
{\mathbf E}[ model_c |data ] % & = & \sum_i Pr(Model_c | z_i^*) \\ 
...
However, this particular log-likelihood function (a sum of logarithms of weighted sums) is a convex function of its parameters, the $\pi_c$, and convexity ensures that any local maximum is a global maximum \cite{mcandrew2019adaptively}.  
