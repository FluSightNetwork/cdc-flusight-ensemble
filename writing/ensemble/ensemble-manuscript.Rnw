...
This strong and consistent performance by the chosen {\tt FSNetwork-TTW} ensemble model is a noteworthy achievement given that our team identified this model prospectively, before the season began, essentially wagering that this ensemble model would have the best performance of any model in the 2017/2018 season, which it did.
