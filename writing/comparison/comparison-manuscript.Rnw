...
\author{Nicholas G Reich, Matthew Biggerstaff, Logan Brooks, Spencer Fox, Michael Johansson, Sasikiran Kandula, Craig McGowan, Evan Moore, Dave Osthus, Evan Ray, Roni Rosenfeld, Jeffrey Shaman, Abhinav Tushar, Teresa Yamana}
...
=======
TBD. 
>>>>>>> 496a2349e1a44c8e204483064bf42c22a1c2a81b
...
Drawing on the different expertise of the five teams allows us to make fine-grained and standardized comparisons of distinct approaches to disease incidence forecasting that use different data sources and models.
