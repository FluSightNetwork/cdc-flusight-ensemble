...
In \Sexpr{best_region_wkahead}, the \Sexpr{n_models} models showed an average forecast score of 
...
when the first observed wILI measurement was between 2.5 and 3.5 percentage points lower than the final observed value, adjusting for model, week-of-year, and target (Figure \ref{fig:delay-analysis}).
