...
Implementation of interventions designed to disrupt disease transmissions, such as vector control measures or mandatory infection prevention protocols at hospitals or health clinics, could be targeted based on forecasted incidence.
...
Our work brings together models from five different institutions (Carnegie Mellon, Columbia University, Los Alamos National Laboratory, University of Massachusetts-Amherst, and University of Texas-Austin), enhancing the methodological diversity of the models presented.
...
To our knowledge, this is the first such documented comparison of multiple forecasting models (from different teams) across multiple seasons for any infectious disease application.
